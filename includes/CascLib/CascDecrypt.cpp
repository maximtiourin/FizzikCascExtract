...
static CASC_ENCRYPTION_KEY CascKeys[] =
{
  ...
  //  { 0x32690BF74DE12530ULL, {0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x?? } },   // 103 WOW-24781patch7.3.0_PTR  legion_73_pan
  //  { 0xBF3734B1DCB04696ULL, {0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x?? } },   // 104 WOW-25079patch7.3.2_PTR
  //  { 0x74F4F78002A5A1BEULL, {0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x?? } },   // 105 WOW-25079patch7.3.2_PTR  SilithusPhase01 map
  { 0, { 0 } }
};
